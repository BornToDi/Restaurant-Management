<template>
  <q-section>
    <div class="flex flex-wrap text-sm pt-3">
      <q-icon color="blue" class="pl-3 md:pl-10 pt-1" name="info"></q-icon>
    ...
    <div class="pl-3 md:pl-10 py-4">
      <form @submit.prevent="addItem">
        <p class="flex flex-col text-gray-600">
          <span class="text-lg text-bold"> VAT / TAX percentage</span>
          <input
        ...
        <p class="py-3">
          <input
            ...
            required
            v-model="itemPrice"
            true-value="Items include VAT/TAX"
          />
          <label class="text-xl text-bold text-gray-800">
            Item prices include VAT/TAX by default</label
          >
        </p>
        <p class="text-gray-600 text-xl text-bold">
          Use In <br />
          <input
            class="h-4 w-4"
            type="checkbox"
    ...
    <div class="row gap-3 px-3 md:px-10 my-4">
      ...
      >
        <span>
          ...
          <br />
          <span class="py-1">
            <q-icon color="blue" name="info" /> {{ item.Price }}
          </span>
          <br />
          <span class="py-1">
...
export default {
  data() {
    return {
      ...
      headline:
        'Please insert VAT/TAX percentage according to authorities. Even if your menu prices include VAT/TAX',
      add: 'Add VAT / TAX',
    };
  },
  methods: {
